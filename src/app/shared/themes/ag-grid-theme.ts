...
/**
 * Dynamic theme that responds to Bootstrap's theme mode.
 * Uses CSS custom properties for seamless light/dark mode transitions.
 *
 * This theme uses withParams with mode names that correspond to
 * Bootstrap's data-bs-theme attribute values.
 */
export const agGridTheme = themeQuartz
  .withParams(
    {
      // Light mode - Bloomberg Daylight
      backgroundColor: '#FFFFFF',
      foregroundColor: '#2C1810',
      chromeBackgroundColor: '#FAF7F2',
      textColor: '#2C1810',
